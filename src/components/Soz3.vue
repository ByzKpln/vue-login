    ...
    <div class="row">
      ...
      <div class="col-md-2 dot" style="padding-left: 28px;">
        <b-nav style="margin-top: 30px; text-align:center; font-family: 'Amatic SC';font-size: 22px;"  tabs>
          ...
          <b-nav-item style="background-color: whitesmoke; border-radius: 25px;" href="http://localhost:8080/#/Soz3" class="col-md-12 z act">Iris Murdoch</b-nav-item>
        </b-nav>  
        <div style="margin-top: 15px;" class="soz">
        <br/>
        <p id="navText" style="text-align:right; font-family: 'Alex Brush'; font-size:18px;">We live in a fantasy world, a world of illusion. The great task in life is to find reality.</p>
        <h6 style="text-align:right; font-weight:bold;"> -Iris Murdoch</h6>     
        </div>
        <hr>
      </div>
