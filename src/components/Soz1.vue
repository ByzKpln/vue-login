    ...
    <div class="row">
      ...
      <div class="col-md-2 dot"  style="padding-left: 28px;">
        <b-nav style="margin-top: 30px; text-align:center; font-family: 'Amatic SC';font-size: 22px;"  tabs>
          <b-nav-item style="background-color: whitesmoke; border-radius: 25px;" href="http://localhost:8080/#/Soz1" class="col-md-12 z act" >Og Mandıno</b-nav-item>
        ...
        <br/>
        <p id="navText" style="text-align:right; font-family: 'Alex Brush'; font-size:18px;">Always render more and better service than is expected of you, no matter what your task may be.</p>
        <h6 style="text-align:right; font-weight:bold;"> -Og Mandino</h6>     
        </div>
        <hr>
      </div>
