    ...
    <div class="row">    
      <div class="col-md-2 dot" style="padding-left: 28px;">
        <b-nav style="margin-top: 30px; text-align:center; font-family: 'Amatic SC';font-size: 22px;"  tabs>
          ...
          <b-nav-item style="background-color: whitesmoke; border-radius: 25px;" href="http://localhost:8080/#/Userpage" class="col-md-12 z act">Mıchelangelo</b-nav-item>
          <b-nav-item style="background-color: whitesmoke; border-radius: 25px;" href="http://localhost:8080/#/Soz2" class="col-md-12 z">Erich Fromm</b-nav-item>
        ...
        <br/>
        <p id="navText" style="text-align:right; font-family: 'Alex Brush'; font-size:18px;">Every block of stone has a statue inside it and it is the task of the sculptor to discover it.</p>
        <h6 style="text-align:right; font-weight:bold;"> -Michelangelo</h6>     
        </div>
        <hr>
      </div>
